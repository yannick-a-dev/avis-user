...
@Configuration
@EnableMethodSecurity  // il y a une partie de la sécurité qui est configuré dans les méthodes
@EnableWebSecurity
				...
				httpSecurity
				        ...
				        .authorizeHttpRequests(
				        	authorize -> authorize
				        	                     ...
				        	                     .requestMatchers(HttpMethod.GET, "/avis").hasAnyAuthority("ROLE_MANAGER","ROLE_ADMINISTRATEUR")
